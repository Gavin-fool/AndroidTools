...
import com.alier.com.controllerlibrary.VHTable.VHTableView;

import java.util.ArrayList;

public class VHTableActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vhtable);
