package com.alier.com.androidtools.ui.uitest.VHTable;
...
import com.alier.com.controllerlibrary.VHTable.VHBaseAdapter;
...
public class VHTableAdapter implements VHBaseAdapter {
    ...
    private ArrayList<String> titleData;//表头数据
    private ArrayList<ArrayList<String>> dataList;//内容数据，含第一列数据（即显示在最左一列的表头）
